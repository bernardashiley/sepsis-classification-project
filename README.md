...
## Conclusion
The model is effective at identifying sepsis risk (77% recall), validating that Age and Glucose are critical indicators. Future work could improve performance using identifying non-linear relationships (e.g., Random Forest).
